...
The following images illustrate the flux of the data sources available. The full documentation can be found in [OSM-Wikidata Map Framework's README](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/blob/v1.1.2/README.md).

| `*:wikidata`                                                                                                                          | `wikidata`+`P*`                                                                                                           | Parts of groups                                                                                                 | Propagation                                                                                                             | Wikidata                                                                                                            |
| ------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| ![osm_name_etymology](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/raw/v1.1.2/images/data/osm_name_etymology.png) | ![osm_wikidata](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/raw/v1.1.2/images/data/osm_wikidata.png) | ![part_of](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/raw/v1.1.2/images/data/part_of.png) | ![propagation](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/raw/v1.1.2/images/data/propagation.png) | ![wd_direct](https://gitlab.com/openetymologymap/osm-wikidata-map-framework/-/raw/v1.1.2/images/data/wd_direct.png) |
